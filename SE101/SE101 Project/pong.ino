/* Programmer of functions.h and functions.c: Kenneth Sinder */
...
void collision() {
    ...
    //if (a <= 6 && b >= paddle_y1_posn && b <= paddle_y1_posn + 1) { // hits the paddle
    if ((ball_x_posn <= 3)
            && (ball_y_posn >= (paddle_y1_posn - 1))
            && (ball_y_posn <= (paddle_y2_posn + 1))) { 
